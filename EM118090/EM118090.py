...
from EM118090.CRC import crc_append, validate_crc
from serial import Serial
from EM118090.enums import Commands, CommandLenght, ResultFormat,Enum
from EM118090.response_parser import parse_response
...
class EM118090:
    def __init__(self, port, baudrate=9600, timeout=1):
        ...
        self.comm = Serial(self.port, self.baudrate, timeout=self.timeout)
    ...
    def get_value(self, device_id, value: Enum):
        ...
        message = SendData(device_id=device_id, mode=4, command=command_value, command_lenght=command_length)
