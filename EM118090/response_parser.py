def parse_response(response, resultformat):
    """
        ...
        """
    if resultformat == 'INT32_3_3':
        return int(response, 16)/1000.0

    elif resultformat == 'INT32_2_3':
        return int(response, 16) / 1000.0

    elif resultformat == 'INT32_5_0':
        return int(response, 16)

    elif resultformat == 'INT16_2_1':
        return int(response, 16) / 10

    elif resultformat == 'INT16_1_3':
        return int(response, 16) / 1000.0

    elif resultformat == 'INT32_6_2':
        return int(response, 16) / 100.0

    elif resultformat == 'INT32_6_1':
        return int(response, 16) / 10.0
